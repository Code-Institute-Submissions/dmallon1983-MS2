let players = {
    ...
    vanDerSar: {
        ...
        caps: "130 caps",
        goals: "0 goals",
        bio: "Edwin van der Sar (born 29 October 1970) is a Dutch former professional player who is currently the chief executive of AFC Ajax, with whom he began his senior playing career in the early 1990s. He is considered to be a member of the club's golden generation and was part of the Ajax team that won the UEFA Champions League in 1995. A goalkeeper, he left Ajax for Juventus in 1999, where he spent two years before moving to England, first to Fulham and then to Manchester United in 2005. There he won a second Champions League title in 2008"
    },
    neuer: {
        name: "Manuel Neuer",
        position: "Goalkeeper",
    ...
    cafu: {
        ...
        caps: "142 caps",
        goals: "5 goals",
        bio: "Known for his pace and energetic attacking runs along the right flank, Cafu is regarded as one of the greatest full-backs of all time, one of the best defenders ever to play in the Italian Serie A, and as one of the greatest Brazilian and South American players of his generation. In 1994, Cafu was crowned South American Footballer of the Year, and in 2004, was named by Pelé in the FIFA 100 list of the world's greatest living players."
    },
    carlos: {
        name: "Roberto Carlos",
        position: "Left Back",
    ...
    lahm: {
        ...
        caps: "113 caps",
        goals: "5 goals",
        bio: "Philipp Lahm (born 11 November 1983) is a German retired professional footballer who played as a right back or defensive midfielder and spent much of his career playing left back. Considered by many to be one of the best defenders of his generation and one of the greatest defenders of all time, Lahm was the captain of Bayern Munich, having led them to numerous honours including the 2013 UEFA Champions League as part of the Treble. He is also a former captain of his national team, which he led to win the 2014 FIFA World Cup, before retiring from international football."
    },
    zanetti: {
        name: "Javier Zanetti",
        position: "Right Back",
        ...
        caps: "145 caps",
        goals: "5 goals",
        bio: "Javier Adelmar Zanetti (born 10 August 1973) is an Argentine former professional footballer who played as a full back or midfielder. With 1,114 official games played, he is tenth on the list of players in history with the most career appearances, and third among the outfield players, behind only to Roberto Carlos and Xavi. Known for his versatility, he was adept on both the left and right wing, having played on both flanks as a full back. On retiring, Inter Milan retired his number 4 jersey and named him as its vice president."
    },
    alves: {
        name: "Dani Alves",
        position: "Right Back",
...
$("li").on("click", function () {
    ...
    $(".modal-goals").html(player.goals);
    $(".modal-caps").html(player.caps);
    $(".modal-nation").html(player.nationality);
    $(".modal-position").html(player.position);
